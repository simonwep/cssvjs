...
* [`<side-or-corner>`](https://developer.mozilla.org/en-US/docs/Web/CSS/linear-gradient#Values) [parser](https://github.com/Simonwep/cssvjs/blob/master/src/lib/ast/css/side-or-corner.js) / [tests](https://github.com/Simonwep/cssvjs/blob/master/test/css/side-or-corner.test.js)
