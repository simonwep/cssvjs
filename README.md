...
* [`<custom-ident>`](https://developer.mozilla.org/en-US/docs/Web/CSS/custom-ident) [parser](https://github.com/Simonwep/cssvjs/blob/master/src/lib/ast/css/custom-ident.js) / [tests](https://github.com/Simonwep/cssvjs/blob/master/test/css/custom-ident.test.js)
* [`<symbols>`](https://developer.mozilla.org/en-US/docs/Web/CSS/symbols) [parser](https://github.com/Simonwep/cssvjs/blob/master/src/lib/ast/css/symbols.js) / [tests](https://github.com/Simonwep/cssvjs/blob/master/test/css/symbols.test.js)
* [`<counters>`](https://developer.mozilla.org/en-US/docs/Web/CSS/counters) [parser](https://github.com/Simonwep/cssvjs/blob/master/src/lib/ast/css/counters.js) / [tests](https://github.com/Simonwep/cssvjs/blob/master/test/css/counters.test.js)
