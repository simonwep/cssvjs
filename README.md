...
* [`<blend-mode>`](https://developer.mozilla.org/en-US/docs/Web/CSS/blend-mode) [parser](https://github.com/Simonwep/cssvjs/blob/master/src/lib/ast/css/blendMode.js) / [tests](https://github.com/Simonwep/cssvjs/blob/master/test/css/blendMode.test.js)
